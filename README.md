...
3. Configure your **RuName (Redirect URI Name)** in your eBay developer account settings under the Redirect Registry, and set the Redirect URL (both accepted and declined) to: `https://httpbin.org/anything`
