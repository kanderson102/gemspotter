...
3. Configure your **RuName (Redirect URI Name)** in your eBay developer account settings under the Redirect Registry, and set the Redirect URL to match your application's custom deep link scheme: `gemspotter://`
